...
class VideoService:
    ...
    def __init__(self, caption, width, height, cell_size, frame_rate, debug = False):
        ...
        Args:
            caption (str): Text set to the top of the window.
            width (int): Initial width value.
            height (int): Initial height value.
            cell_size (int): Initial cell size value.
            frame_rate (int): Initial speed of items moving on the screen.
